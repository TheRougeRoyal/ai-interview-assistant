...
function getVendor(): "openai" | "mock" {
...
function getModule() {
  ...
  return vendor === "openai" ? openaiVendor : mockVendor;
}
...
export function getCurrentVendor(): "openai" | "mock" {
  return getVendor();
}

export function isVendorAvailable(vendor: "openai" | "mock"): boolean {
  if (vendor === "openai") {
