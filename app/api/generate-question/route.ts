...
/**
 * Generate an interview question based on questionIndex and role
 * Request: { questionIndex: number, role: string, resumeContext?: string }
 * Response: { prompt, targetDurationMs, difficulty }
 */
