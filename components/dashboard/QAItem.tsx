...
export function QAItem({ questionIndex, difficulty, question, answerText, durationMs, timeTakenMs, rubric }: QAItemProps) {
  return (
    <Card>
      ...
      <CardContent className="space-y-4">
        ...
        <div className="flex items-center justify-between pt-2 border-t">
          <div className="flex items-center gap-4 text-xs text-muted-foreground">
            ...
            {timeTakenMs && (
              <span>Taken: {formatDuration(timeTakenMs)}</span>
            )}
          </div>
